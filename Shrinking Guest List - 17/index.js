...
console.log("\n\nSorry boys, ".concat(impPeople[2], " couldn't make it.\n"));
...
for (var i = impPeople.length - 1; i >= 0; i--) {
    if (i > 1) {
        console.log("Sorry, ".concat(impPeople[i], ". You gotta go bud. Be prepared though we will meet on the next day"));
        impPeople.pop();
    }
    else {
        console.log("\nHey ".concat(impPeople[i], ". You are still in. Make sure you come, or I will break your legs the next time I see ya."));
        impPeople.pop();
    }
}
