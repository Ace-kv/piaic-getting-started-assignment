var places = ["Switzerland", "Saudi Arabia", "Turkey", "Italy", "Bosnia"];
var alphPlaces = places.toSorted(); // toSorted gives the following error: Property 'toSorted' does not exist on type 'string[]'
